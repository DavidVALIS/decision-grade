...
What the page does not yet do is directly measure the framework's actual target: the rate at which AI-assisted executive analysis contains unsupported causal claims, hidden assumptions, invalid comparisons, phantom precision, or recommendations that do not follow from the evidence. The evidence below establishes a floor for the wider problem. The specific rate of structural-reasoning failure in deployed decision workflows remains undermeasured. That gap is addressed in the [closing section of this page](#what-is-not-yet-measured).
...
This is the most important section on the page. The seven anchor sources above establish a floor for the wider problem. None of them directly measures the framework's actual target: the rate at which AI-assisted executive analysis contains unsupported causal claims, hidden assumptions, invalid comparisons, phantom precision, or recommendations that do not follow from the evidence.
