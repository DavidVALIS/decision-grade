...
Two further studies widen the floor. CLAIM-BENCH (IJCNLP 2025, [arXiv 2506.08235](https://arxiv.org/abs/2506.08235)) tested six LLMs on more than 300 claim-evidence pairs from AI research papers and found gaps in claim-to-evidence reasoning that close only with multi-pass prompting. SECQUE (ACL GEM 2025, [arXiv 2504.04596](https://arxiv.org/abs/2504.04596)) tested seven LLMs on 565 expert-written SEC-filing questions; analyst-insight generation was the hardest task category across all models tested.
...
<Steps>
  ...
  <Step title="If you are contesting the framework">
    Contest these seven anchor sources directly. They are the studies the framework rests on. If you can refute three of them, the framework's empirical floor weakens materially.
  </Step>
</Steps>
