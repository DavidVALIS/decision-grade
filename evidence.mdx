...
You'll like working with this assistant. You'll trust this assistant. And every so often the assistant will hand you a polished answer whose underlying frame is broken, and you won't catch it because nothing in the answer looks wrong.

The fix isn't "stop using AI." That isn't going to happen. The fix is: don't let an AI's answer count as a decision until something independent has checked it.
