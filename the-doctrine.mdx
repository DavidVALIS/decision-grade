...
- **Which assumptions the conclusion rests on, not just which are listed.** An assumption register that names ten cosmetic assumptions while the assumption the whole conclusion rests on sits unstated is gaming. Audits sample for assumptions that, if flipped, would change the conclusion, and confirm those are the ones in the register.
