...
import { IconSearch, IconSparkle, IconGitHub, IconDots, ValisMark } from '@/components/icons';
    ...
    <header className="dg-topbar">
      <div className="dg-topbar-inner">
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          <button className="dg-search" type="button" aria-label="Search">
            <IconSearch size={14} />
            <span>Search or ask...</span>
            <span className="kbd">/K</span>
          </button>
          <a className="icon-btn" title="Source on GitHub" href={REPO_URL} target="_blank" rel="noreferrer">
            <IconGitHub size={16} />
          </a>
          <button className="icon-btn" type="button" title="Ask VALIS" aria-label="Ask VALIS">
            <IconSparkle size={16} />
          </button>
          <button className="icon-btn" type="button" title="More" aria-label="More">
            <IconDots size={16} />
          </button>
        </div>
      </div>
