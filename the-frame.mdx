...
```mermaid
flowchart TD
    L1["Layer 1<br/>Drafting costs collapse<br/>$0.001 to $0.02 per 1,000 words"]
    L2["Layer 2<br/>Review gates check style and coherence,<br/>not structural validity"]
    L3["Layer 3<br/>Analysts rewarded for speed to briefing,<br/>not forecast accuracy"]
    L4["Layer 4<br/>Clients never see the claim-source map<br/>behind the polished deliverable"]
    L1 --> L2 --> L3 --> L4
    L4 -.->|Feedback: opacity hides damage,<br/>incentives intensify| L1
