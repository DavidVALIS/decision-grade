...
<Note>
  **In short:** Most executive AI guidance is scoped to the wrong problem. Hallucinations are detectable. The real risk has moved one layer down, to output that reads cleanly, fact-checks, and still reasons badly.
</Note>
